...
caffe_root = '/home/hi/CAFFE_SSD-fssd/'
os.chdir(caffe_root)
...
def parse_args():
    ...
    parser.add_argument('--model_def',
                        default='models/VGGNet/FSSD_300x300/80000000/deploy.prototxt')
    parser.add_argument('--image_resize', default=300, type=int)
    parser.add_argument('--model_weights',
                        default='ssd_models/VGGNet/FSSD_300x300/80000000/VGG_VOC0712_FSSD_300x300_iter_120000.caffemodel')
